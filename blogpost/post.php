...
<head>
    ...
    <title>Blog Post - FreeTask</title>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="post-heading">
                        <h1>Easy Install LEMP STACK</h1>
                        <h2 class="subheading">Easy way to install LEMP STACK</h2><span class="meta">Posted by&nbsp;<a href="#">GGS</a>&nbsp;on 2-2-2021</span></div>
                </div>
            </div>
        </div>
    </header>
